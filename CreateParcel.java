...
public class CreateParcel {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException {
		...
		Customer cust1 = new Customer("123", "456", "789", "Utkarsh Jain", "utkarshjain528@gmail.com", "9565432188",
				"Lalitpur(U.P.)");
		Customer cust2 = new Customer("111", "222", "333", "Vivek Jain", "vivekjain@gmail.com", "8982322095",
				"Dabra(M.P.)");
		Customer cust3 = new Customer("234", "567", "891", "Shubham Jain", "shubhamjain@gmail.com", "9644054482",
				"Gwalior(M.P.)");
		Customer cust4 = new Customer("345", "678", "910", "Leena Chaoudhary", "leenachoudhary@gmail.com", "8839094740",
				"Dewas(M.P.)");
